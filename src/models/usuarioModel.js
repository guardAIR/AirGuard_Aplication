...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT NomeUsuario, SobrenomeUsuario, EmailUsuario, dtCadastro, NomeEmpresa, idEmpresa, id, isADM FROM vwUsuario WHERE EmailUsuario = '${email}' AND SenhaUsuario = '${senha}';
    `;
